  ...
  return (
    <>
      ...
      <p>
        ...
        Policy outlines the types of information we collect from our users, how
        we use that information, and the measures we take to protect it.
      </p>
      ...
      <ul>
        <li>
          <strong>Discord User IDs</strong>: A unique identifier provided by
          Discord for each user.
        </li>
        <li>
          <strong>Discord Username</strong>: The username you use on Discord.
        </li>
        <li>
          <strong>Discord Global Display Names</strong>: The display name that
          is visible to other users on Discord.
        </li>
        <li>
        ...
        <li>
          ...
          browser, and operating system you use to access CRSS.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Account Management</strong>: To verify your identity and
          manage your account on CRSS.
        </li>
        <li>
          <strong>Communication</strong>: To send notifications, updates, and
          other relevant communications related to CRSS.
        </li>
        <li>
          <strong>Security and Moderation</strong>: To ensure the safety and
          security of our community, including the detection and prevention of
          fraudulent or unauthorized activities.
        </li>
        <li>
          <strong>Improvement of Services</strong>: To enhance and improve the
          user experience on CRSS.
        </li>
      </ul>

      <h2 id="sharing-and-disclosure-of-information">
        4. Sharing and Disclosure of Information
      </h2>

      <p>
        CRSS does not sell, trade, or otherwise transfer your personal
        information to outside parties except under the following circumstances:
      </p>

      <ul>
        <li>
          <strong>Legal Compliance</strong>: We may disclose your information if
          required to do so by law or in response to a valid request from a law
        ...
        <li>
          ...
          of CRSS, our users, or others.
        </li>
        <li>
          <strong>Service Providers</strong>: We may engage third-party service
          providers to perform functions on our behalf, such as server hosting
          and maintenance. These providers have access to the necessary
          information only to perform their functions and are obligated to
      ...
      <p>
        ...
        applicable laws. Once your information is no longer needed, we will
        delete or anonymize it in a secure manner.
      </p>
      ...
      <ul>
        ...
        <li>Withdraw your consent to the processing of your information.</li>
      </ul>
      ...
      <p>
        CRSS reserves the right to update or modify this Privacy Policy at any
        time. Any changes will be effective immediately upon posting the revised
        policy. We will notify you of any significant changes through the
        Discord server or by other means. Your continued use of CRSS after any
        modifications to this Privacy Policy constitutes your acceptance of the
        updated terms.
      </p>
      ...
      <p>
        <strong>Email:</strong>{' '}
        <Link href="mailto:admins@crss.cc">admins@crss.cc</Link> <br />
        <strong>Discord Server:</strong>{' '}
        <Link href="https://discord.gg/rGjCKawPkS">
          https://discord.gg/rGjCKawPkS
        </Link>
      </p>
      ...
      <p>
        By using Clyde&apos;s Real Survival SMP, you acknowledge that you have
