...
**_I have a question!_** Check the [FAQs](#faqs) section to see if your question was already answered, if it wasn't join our [Discord](https://discord.gg/rGjCKawPkS) server or open up an issue.
...
* Use one of these prefixes in your commit messages:
    ...
    * `chore:` When you do fixed something, but it doesn't affect the website in terms of functionality.
